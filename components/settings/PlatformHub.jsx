  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 24, fontSize: 11, color: "rgba(241,243,249,0.25)", lineHeight: 1.7 }}>
        Leet9 is platform-agnostic — Steam, PSN, Xbox, Riot Games, GOG, itch.io, EA, Ubisoft Connect, Twitch, Discord and all future platforms feed the same unified game catalogue.
