...
export async function GET(request) {
  ...
  if (!XBOX_CLIENT_ID) {
    return apiError("XBOX_NOT_CONFIGURED", "Xbox integration is not configured.", 503);
  }
  ...
  headers.append("Set-Cookie", `xbox_oauth_state=${state}; ${cookieOpts}`);
  headers.append("Set-Cookie", `xbox_oauth_return=${encodeURIComponent(returnTo)}; ${cookieOpts}`);
