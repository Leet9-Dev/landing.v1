 ...
 */
export async function processEventV2(prisma, userId, eventType, payload, idempotencyKey) {
  ...
  for (const rule of rules) {
    ...
    // Eligibility: reuse the same checks as v1 (inline to avoid circular import).
