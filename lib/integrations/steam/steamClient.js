...
/**
 * Resolve a Steam vanity URL (custom profile URL) to a steamid64.
 * Returns the steamid64 string on success, or null if not found.
 *
 * @param {string} vanityUrl  e.g. "gabelogannewell" (not the full URL)
