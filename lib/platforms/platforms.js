...
export const PLATFORM_PROVIDERS = {
  ...
  gog: {
    ...
    notes: "GOG Galaxy — DRM-free library. Public profiles use the GOG username.",
  },
  itch: {
    id: "itch",
    label: "itch.io",
    ...
    notes: "itch.io indie game library. Requires ITCH_API_KEY for live sync.",
  },
  ea: {
    id: "ea",
    label: "EA App",
    ...
    notes: "EA App library — Apex Legends, EA FC and other EA titles.",
  },
  ubisoft: {
    id: "ubisoft",
    ...
    notes: "Ubisoft Connect library — AC, Far Cry, Rainbow Six, The Division and other Ubisoft titles. Requires OAuth.",
  },
  twitch: {
    id: "twitch",
    label: "Twitch",
    ...
    notes: "Twitch social source — streaming activity, top games, hours broadcast. Not a game-ownership library.",
  },
  discord: {
    id: "discord",
    label: "Discord",
    ...
    notes: "Discord activity source — game presence, launch tracking. Not a game-ownership library.",
  },
};
...
export const COMING_SOON_PLATFORMS = [
  {
    ...
    accentColor: "#E4000F",
    description:
      "Nintendo does not offer a public game library API. Community solutions (NSO scraping) are unofficial and fragile — we’re watching for an official path.",
  },
];
